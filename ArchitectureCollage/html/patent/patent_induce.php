              ...
              <li name="111"  class="sider_li_1 now_li "><img src="../../image/patent.png" width="40">专利情况</li>
                    <ul class="sider_ul_2">
                       <li class="sider_li_2  menu_chioce"><a href="patent.php">数据查询</a></li>
                        ...
                        <li class="sider_li_2 menu_chioce  now_li_2"><a href="patent_induce.php">数据导入</a></li>
                      </ul>
          ...
          <div id="right-text">
            ...
            <div class="table_input_area">
              ...
              <?php
                ...
                echo'<tr><th>专利类型</th><th>专利授权国</th><th>专利状态</th><th> 发明人</th><th>专利名称</th><th>申请号或授权号</th></tr>';
                echo'<tr><td>专利群</td><td>中国</td><td>公开</td><td>张小龙</td><td>新型挖掘机</td><td>1065755382</td>

                ';
                echo'</table>';
                echo'
                <form method="post" action="../../php/data_induce.php" enctype="multipart/form-data">
                  <input type="hidden" name="table_name" value="patent">     
