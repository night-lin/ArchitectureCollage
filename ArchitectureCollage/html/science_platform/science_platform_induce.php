          ...
          <div id="sider">
              ...
              <li name="111"  class="sider_li_1"><img src="../../image/patent.png" width="40">专利情况</li>
               ...
               <li class="sider_li_1 now_li"><img src="../../image/plat.png" width="40">科技平台</li>
                   <ul class="sider_ul_2">
                        <li class="sider_li_2 menu_chioce"><a href="../science_platform/science_platform.php">数据查询</a></li>
                        <li class="sider_li_2 menu_chioce"><a href="../science_platform/science_platform_add.php">数据管理</a></li>
                        <li class="sider_li_2 menu_chioce now_li_2"><a href="../science_platform/science_platform_induce.php">数据导入</a></li>
                      </ul>
          ...
          <div id="right-text">
            ...
            <div class="table_input_area">
              ...
              <?php
                ...
                echo'<tr><th>平台类别</th><th>平台名称</th><th>平台负责人</th><th>合作单位</th><th>签约时间</th><th>合作经费</th><th>产学研合作机构</th></tr>';
                echo'<tr><td>省级</td><td>水资源战略发展平台</td><td>张晓明</td><td>福州大学</td><td>2015-1-15</td><td>50万</td><td>无</td>

                ';
                echo'</table>';
                echo'
                <form method="post" action="../../php/data_induce.php" enctype="multipart/form-data">
                  <input type="hidden" name="table_name" value="science_platform">     
