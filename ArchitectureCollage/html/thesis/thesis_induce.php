               ...
               <li name="thesis now_li "  class="sider_li_1"><img src="../../image/thesis.png" width="40">论文发表</li>
                   <ul class="sider_ul_2">
                     <li class="sider_li_2 menu_chioce"><a href="thesis.php">数据查询</a></li>
                        ...
                        <li class="sider_li_2 menu_chioce now_li_2"><a href="thesis_induce.php">数据导入</a></li>
          ...
          <div id="right-text">
            ...
            <div class="table_input_area">
              ...
              <?php
                ...
                echo'<tr><th>论文类型</th><th>论文作者</th><th>论文题目</th><th>期刊或会议名称</th><th>CN/ISSN</th><th>主办单位</th><th>影响因子</th><th>发表年份</th><th>他引频次</th></tr>';
                echo'<tr><td>国内会议论文集</td><td>王小明</td><td>《论桥梁设计》</td><td>《建筑设计》29期</td><td>1546546</td><td>福州大学</td><td>xx因子</td><td>2011</td><td>201</td>

                </tr>';
                echo'</table>';
                echo'
                <form method="post" action="../../php/data_induce.php" enctype="multipart/form-data">
                  <input type="hidden" name="table_name" value="thesis">
